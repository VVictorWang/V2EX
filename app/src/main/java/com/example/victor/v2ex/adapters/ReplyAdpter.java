...
import com.example.victor.v2ex.activity.BigPhotoActivity;
import com.example.victor.v2ex.activity.MemberActivity;
            ...
            if (!members.isEmpty()) {
                ...
                if (member.isHasbitmap()) {
                    ((ContentViewHolder)holder).imageView.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            Intent intent4 = new Intent(context, BigPhotoActivity.class);
