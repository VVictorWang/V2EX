...
public class Neweset extends AppCompatActivity {
...
//            case R.id.hot_item:
//                Intent intent1 = new Intent(Neweset.this, HotActivity.class);
...
//    }
    ...
    class MyTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            if (s != null) {
//                themes = Show(s);
                adapter = new ViewAdapter(Neweset.this,recyclerView, themes,bitmaps);
...
//                dialog.dismiss();
                ...
                Toast.makeText(Neweset.this, "请求数据失败", Toast.LENGTH_LONG);
            }
            dialog.dismiss();
        }
    }
